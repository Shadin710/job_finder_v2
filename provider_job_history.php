<?php
   ...
   // $main_em  = $_SESSION['email'];
    ...
    $sql_post_job  = "SELECT * FROM jobs WHERE email = '$email'";    
									...
									<div class="job-item">
										<div class="item-overlay">
											<div class="job-info">
												...
												<span class="tr-title">
													<a href= overview_provider_jobs_own.php?id=' . $row_jobs['id'] . '>' . $row_jobs['position'] . '</a>
													<span><a href=overview_provider_jobs_own.php?id=' . $row_jobs['id'] . '>Open</a></span>
												</span>
