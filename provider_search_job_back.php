...
<div class="container bootstrap snippets bootdey">
    <hr>
    <ol class="breadcrumb">
        <li><a href="provider_home.php">Homepage</a></li>
        <li><a href="provider_profile.php">Profile</a></li>
        <li><a href="post_job.php">Post Job</a></li>
        <li><a href="provider_notification.php">Notification</a></li>
        <li><a href="provider_job_history.php">Job History</a></li>
                    ...
                    while ($search_array=mysqli_fetch_assoc($search_object)) 
                    {
                        ...
                        <div class="row">
                            <a href="#">
                                ...
                                <a href=provider_search_overview.php?id=' . $search_array['id'] . '><h3>' . $search_array['comName'] . '</h3></a>
