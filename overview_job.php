...
<div class='container'>
             ...
             <div class="row">
                <div class="col-75"><a href="admin_dashboard.php"><input type="submit" value="Cancel" id="app"></a></div>
                <div class="col-25"> <a href="delete_job.php"><input type="submit" value="Delete" id="rep"></a></div>
